function I_MSVA_nfa_bmg(input_name)
...
while endident==0
        ...
        loadpict('buche.jpeg' , 1, 500 , 350);                    % prepare buche
        loadpict('nenuphar.jpeg',1,-500 , 350);                   % prepare nenuphar
        if ismember(Seqcondident(ident),[4 8])
                loadsound('frog1.1.wav',1);
        elseif ismember(Seqcondident(ident),[5 6])
                loadsound('frog1.2.wav',1);
        elseif ismember(Seqcondident(ident),[1 7])
                loadsound('frog1.3.wav',1);
        elseif ismember(Seqcondident(ident),2)
                loadsound('frog1.4.wav',1);
        elseif ismember(Seqcondident(ident),3)
                loadsound('frog1.5.wav',1);
