function J_MSVA_nmg_bfa(input_name)
...
while endexp == 0
       ...
       if ismember(trial,stopTrials)
        ...
        loadpict('buche.jpeg' , 1, 500 , 350);                    % prepare buche
        loadpict('nenuphar.jpeg',1,-500 , 350);                   % prepare nenuphar
            if 1 <= SeqStim(trial) && SeqStim(trial) <= 6 
                loadsound('frog1.1.wav',1);
            elseif 39 <= SeqStim(trial) && SeqStim(trial) <= 40
                loadsound('frog1.1.wav',1);
            elseif 7 <= SeqStim(trial) && SeqStim(trial) <= 14
                loadsound('frog1.2.wav',1);
            elseif 15 <= SeqStim(trial) && SeqStim(trial) <= 22
                loadsound('frog1.3.wav',1);
            elseif 23 <= SeqStim(trial) && SeqStim(trial) <= 30
                loadsound('frog1.4.wav',1);
            elseif 31 <= SeqStim(trial) && SeqStim(trial) <= 38
                loadsound('frog1.5.wav',1);
            elseif 41 <= SeqStim(trial) && SeqStim(trial) <= 48
                loadsound('frog2.1.wav',1);
            elseif 49 <= SeqStim(trial) && SeqStim(trial) <= 56
                loadsound('frog2.2.wav',1);
            elseif 57 <= SeqStim(trial) && SeqStim(trial) <= 64
                loadsound('frog2.3.wav',1);
            elseif 65 <= SeqStim(trial) && SeqStim(trial) <= 72
                loadsound('frog2.4.wav',1);
            elseif 73 <= SeqStim(trial) && SeqStim(trial) <= 80
...
while endident==0
        ...
        loadpict('buche.jpeg' , 1, 500 , 350);                    % prepare buche
        loadpict('nenuphar.jpeg',1,-500 , 350);                   % prepare nenuphar
        if ismember(Seqcondident(ident),[1 2])
                loadsound('frog1.1.wav',1);
        elseif ismember(Seqcondident(ident),[3 4])
                loadsound('frog1.2.wav',1);
        elseif ismember(Seqcondident(ident),[5 6])
                loadsound('frog1.3.wav',1);
        elseif ismember(Seqcondident(ident),7)
                loadsound('frog1.4.wav',1);
        elseif ismember(Seqcondident(ident),8)
                loadsound('frog1.5.wav',1);
        elseif ismember(Seqcondident(ident),[9 10])
                loadsound('frog2.1.wav',1);
        elseif ismember(Seqcondident(ident),[11 12])
                loadsound('frog2.2.wav',1);
        elseif ismember(Seqcondident(ident),[13 14])
                loadsound('frog2.3.wav',1);
        elseif ismember(Seqcondident(ident),15)
                loadsound('frog2.4.wav',1);
