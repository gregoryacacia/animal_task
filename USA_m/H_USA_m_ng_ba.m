function H_USA_m_ng_ba(input_name)
...
while endexp == 0
       ...
       if ismember(trial,stopTrials)
        ...
        loadpict('buche.jpeg' , 1, 500 , 350);                    % prepare buche
        loadpict('nenuphar.jpeg',1,-500 , 350);                   % prepare nenuphar
            if ismember(SeqStim(trial),[1 2 3 4 9 10 11 12])
                loadsound('frog1.1.wav',1);
            elseif ismember(SeqStim(trial),[17 18 19 20 25 26 27 28])
                loadsound('frog1.2.wav',1);
            elseif ismember(SeqStim(trial),[33 34 35 36 41 42 43 44])
                loadsound('frog1.3.wav',1);
            elseif ismember(SeqStim(trial),[49 50 51 52 57 58 59 60])
                loadsound('frog1.4.wav',1);
            elseif ismember(SeqStim(trial),[65 66 67 68 73 74 75 76])
                loadsound('frog1.5.wav',1);
            elseif ismember(SeqStim(trial),[5 6 7 8 13 14 15 16])
                loadsound('frog2.1.wav',1);
            elseif ismember(SeqStim(trial),[21 22 23 24 29 30 31 32])
                loadsound('frog2.2.wav',1);
            elseif ismember(SeqStim(trial),[37 38 39 40 45 46 47 48])
                loadsound('frog2.3.wav',1);
            elseif ismember(SeqStim(trial),[53 54 55 56 61 62 63 64])
                loadsound('frog2.4.wav',1);
            elseif ismember(SeqStim(trial),[69 70 71 72 77 78 79 80])
...
while endident==0
        ...
        loadpict('buche.jpeg' , 1, 500 , 350);                    % prepare buche
        loadpict('nenuphar.jpeg',1,-500 , 350);                   % prepare nenuphar
        if ismember(Seqcondident(ident),[6 7])
                loadsound('frog1.1.wav',1);
        elseif ismember(Seqcondident(ident),[1 8])
                loadsound('frog1.2.wav',1);
        elseif ismember(Seqcondident(ident),[2 3])
                loadsound('frog1.3.wav',1);
        elseif ismember(Seqcondident(ident),4)
                loadsound('frog1.4.wav',1);
        elseif ismember(Seqcondident(ident),5)
                loadsound('frog1.5.wav',1);
        elseif ismember(Seqcondident(ident),[14 15])
                loadsound('frog2.1.wav',1);
        elseif ismember(Seqcondident(ident),[9 16])
                loadsound('frog2.2.wav',1);
        elseif ismember(Seqcondident(ident),[10 11])
                loadsound('frog2.3.wav',1);
        elseif ismember(Seqcondident(ident),12)
                loadsound('frog2.4.wav',1);
        elseif ismember(Seqcondident(ident),13)
                loadsound('frog2.5.wav',1);
        end
